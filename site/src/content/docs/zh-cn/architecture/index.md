...
先沿[一次请求怎样穿过 BearAgent](/BearAgent/zh-cn/architecture/runtime-flow/)看完整顺序，再用
[P1 为什么这样设计](/BearAgent/zh-cn/architecture/p1-decisions/)理解单进程、Event、默认拒绝 Policy、相对路径、原子输出和
串行 Loop 的取舍。准备修改实现时，从[开发者入口](/BearAgent/zh-cn/development/)进入代码。
