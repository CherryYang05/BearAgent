...
[F-0007 workspace 只读 Tool 实现导读](/BearAgent/zh-cn/development/workspace-read-tools/)，提交点和 Artifact 见
[F-0008 原子输出与 Artifact 实现导读](/BearAgent/zh-cn/development/atomic-output-artifacts/)。F-0016 接线时，只调用
