...
Tool 与 `run/inspect/events` 已接通。请从[P1 主学习路线](/BearAgent/zh-cn/learn/)或
[一次文件任务的当前完整路径](/BearAgent/zh-cn/learn/agent-loop-file-task/)开始阅读。
:::
...
- [状态和预算怎样计算](/BearAgent/zh-cn/learn/runtime-state-and-budgets/)
- [一个 Tool 请求为什么要过四道检查](/BearAgent/zh-cn/learn/tool-execution-boundary/)
- [一次请求怎样穿过 BearAgent](/BearAgent/zh-cn/architecture/runtime-flow/)
- [现在实现到了哪里](/BearAgent/zh-cn/project/status/)
