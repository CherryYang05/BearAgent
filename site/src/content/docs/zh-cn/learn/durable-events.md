...
消息或 Tool 参数。从具体输出理解 projection 异常、空页与退出码，继续读
[中断后怎样读懂检查结果](/zh-cn/learn/replay-and-check/)；参数查阅见[命令行手册](/zh-cn/guides/cli/)。
...
这些是 P2 的后续工作。F-0003 先把“发生过什么”可靠留下，F-0021 已能独立从这些 Event 重建状态；
恢复执行还要决定“应该怎样继续”。
