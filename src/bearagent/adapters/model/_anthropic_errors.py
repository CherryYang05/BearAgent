"""Normalize Anthropic SDK failures without retaining untrusted response data."""
...
def classify_anthropic_error(cause: BaseException) -> ModelProviderError:
    ...
    if isinstance(cause, APITimeoutError | DeadlineExceededError | TimeoutError):
    ...
    if isinstance(cause, BadRequestError | RequestTooLargeError | UnprocessableEntityError):
        return provider_error(
