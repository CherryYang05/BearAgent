...
- [F-0020：保护本机运行资料并简化首次使用](F-0020-safe-local-startup.md) — implemented

## P2：可恢复执行语义

- [F-0021：不用 projection，也能重建 Run 并检查未结束的执行](F-0021-event-replay-startup-check.md) — implemented
